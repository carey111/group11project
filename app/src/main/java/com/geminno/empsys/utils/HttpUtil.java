package com.geminno.empsys.utils;
...
import com.geminno.empsys.application.MyApplication;
import com.geminno.empsys.mod.EBmessage;
import com.geminno.empsys.mod.TokenMod;
	...
	public static void getToken(final String id, final String username) {
		...
		x.http().post(params, new CommonCallback<String>() {
			...
			public void onSuccess(String s) {
				...
				SharedPreferences sharedPreferences = MyApplication.getObjectContext()
				.getSharedPreferences("user", Context.MODE_PRIVATE);
